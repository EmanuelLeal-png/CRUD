...
const produtoController = {
    ...
    getProdutoById: async (req, res) => {
        try {
            const produto = await Produto.findByPk(req.params.id, { include: [{ model: Categoria, as: 'categoriaInfo' }] });
            if (!produto) {
    ...
    getAllProdutos: async (req, res) => {
        try {
            ...
            if (categoria) {
                ...
                produtos = await Produto.findAll({ include: [{ model: Categoria, as: 'categoriaInfo' }] });
            }
